...
### I extracted the OS field from an event and saved it as "platform"
...
### **I performed a search to create a dashboard for the most popular operating systems using the web app.**
